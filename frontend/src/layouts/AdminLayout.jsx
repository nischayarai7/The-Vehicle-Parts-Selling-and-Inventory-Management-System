      ...
      <aside className="admin-sidebar">
        ...
        <div className="admin-sidebar-nav-container">
          ...
          <nav className="admin-nav">
            <NavLink to="/admin/store-settings" className={({ isActive }) => isActive ? "nav-item active" : "nav-item"}>
              <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> Store Settings
            </NavLink>
