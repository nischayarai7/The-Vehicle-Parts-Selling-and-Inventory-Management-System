    ...
    <div className="directory-container">
      ...
      {loading ? (
        <div className="directory-loader">
          <svg className="refresh-icon-svg spinning" style={{ width: '16px', height: '16px' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M23 4v6h-6M1 20v-6h6"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>
                    ...
                    <tr key={c.id}>
                      ...
                      <td style={{ textAlign: 'right' }}>
                        <Link to={`/staff/customers/${c.id}`} className="btn-view-details">
                          View Details
                          <svg style={{ width: '12px', height: '12px' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                        </Link>
                      </td>
                    </tr>
                  ))
