        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    condition = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "New"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_part_compatibilities", x => new { x.part_id, x.vehicle_id });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_part_compatibilities_vehicles_vehicle_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_part_compatibilities_vehicle_id",
